...
import java.util.ArrayList;
    ...
    public class ParentManageChildActivity extends AppCompatActivity {
        ...
        private static final String SOAP_ACTION = "http://securitylessons-001-site1.btempurl.com/displayDataOfChild";
        private static final String OPERATION_NAME = "displayDataOfChild";// your webservice web method name
        private static final String SOAP_ACTION_ACTIVE = "http://securitylessons-001-site1.btempurl.com/AcceptChild";
        private static final String OPERATION_NAME_ACTIVE = "AcceptChild";// your webservice web method name
        static ParentManageChildActivity ManageData;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            ManageData=this;
            tableLayout=(TableLayout)findViewById(R.id.TableLayoutParentManageChildrenusers);
           DisplayDataForManage manage_data = new DisplayDataForManage();
            manage_data.execute();
        }
        public static ParentManageChildActivity getInstance(){
            return   ManageData;
        }
         ...
         */
            ...
            String[] headerText={"ID    ","Name    "," Email "," Mobile "," Accept ","  Allow Access "};
        ...
        public class AllowAccessData extends AsyncTask<String,String,String>
        {
            ...
            protected void onPostExecute(String result)
            {
                ...
                if (result.equals("Succeed")) {
                    Toast.makeText ( ParentManageChildActivity.this, "Allowed Access Successfully", Toast.LENGTH_LONG ).show ();

                }
                else if (result.equals("Fail")||result.isEmpty()==true) {
                    Toast.makeText ( ParentManageChildActivity.this, "Fail to Allowed Access", Toast.LENGTH_LONG ).show ();
