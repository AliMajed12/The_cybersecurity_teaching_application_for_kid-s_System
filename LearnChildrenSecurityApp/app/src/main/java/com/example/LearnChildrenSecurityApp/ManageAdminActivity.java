...
public class ManageAdminActivity extends AppCompatActivity {
    ...
    private static final String SOAP_ACTION = "http://securitylessons-001-site1.btempurl.com/displayDataOfAdmin";
    private static final String OPERATION_NAME = "displayDataOfAdmin";// your webservice web method name
    private static final String SOAP_ACTION_ACTIVE = "http://securitylessons-001-site1.btempurl.com/AcceptAdmin";
    private static final String OPERATION_NAME_ACTIVE = "AcceptAdmin";// your webservice web method name
    static  ManageAdminActivity ManageData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ManageData=this;
        tableLayout=(TableLayout)findViewById(R.id.TableLayoutAdminManageUsers);
        DisplayDataForManage manage_data = new DisplayDataForManage();
        manage_data.execute();
    }
    public static ManageAdminActivity getInstance(){
        return   ManageData;
    }
    ...
    public class AllowAccessData extends AsyncTask<String,String,String>
    {
        ...
        protected void onPostExecute(String result)
        {
            ...
            if (result.equals("Succeed")) {
                Toast.makeText ( ManageAdminActivity.this, "Allowed Access Successfully", Toast.LENGTH_LONG ).show ();

            }
            else if (result.equals("Fail")||result.isEmpty()==true) {
                Toast.makeText ( ManageAdminActivity.this, "Fail to Allowed Access", Toast.LENGTH_LONG ).show ();
        ...
        protected String doInBackground(String... params)
        {
            ...
            request.addProperty("AdminID",params[0]);
