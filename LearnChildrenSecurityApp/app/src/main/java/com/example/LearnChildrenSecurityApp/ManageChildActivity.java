...
public class ManageChildActivity extends AppCompatActivity {
    ...
    static ManageChildActivity ManageData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ManageData=this;
        tableLayout=(TableLayout)findViewById(R.id.TableLayoutManageChildrenUsers);
        DisplayDataForManage manage_data = new DisplayDataForManage();
        manage_data.execute();
    }
    public static ManageChildActivity getInstance(){
        return   ManageData;
    }
    ...
    public class AllowAccessData extends AsyncTask<String,String,String>
    {
        ...
        protected void onPostExecute(String result)
        {
            ...
            if (result.equals("Succeed")) {
                Toast.makeText ( ManageChildActivity.this, "Allowed Access Successfully", Toast.LENGTH_LONG ).show ();

            }
            else if (result.equals("Fail")||result.isEmpty()==true) {
                Toast.makeText ( ManageChildActivity.this, "Fail to Allowed Access", Toast.LENGTH_LONG ).show ();
